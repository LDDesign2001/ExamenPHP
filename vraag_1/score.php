...
$scorenummer = $_GET['score'];
$score = $gekozenComponist['scores'][$scorenummer];
?>
...
<p><a href="index.php?composer=<?php echo $gekozenNummer?>">back</a></p>
<h1><?php echo $score['name'];?></h1>
<h2><?php echo $gekozenComponist['name'];?></h2>
<div>
